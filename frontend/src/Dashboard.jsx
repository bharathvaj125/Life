...
// Default export so this whole subtree (and its dependents — Framer Motion,
// html-to-image, all dashboard panels) can be code-split via React.lazy and
// kept out of the bundle an unauthenticated visitor has to download.
